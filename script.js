...
inp_btn.onclick = () => {
    ...
    if (inp_name.value === "" || inp_comment.value == "" || inp_so.value == "") {
        inp_name.style.border = "1px solid red";
        inp_name.style.borderRight = "0px solid transparent";
        inp_comment.style.border = "1px solid red";
        inp_comment.style.borderRight = "5px solid red";
        inp_btn.style.border = "1px solid red";
        inp_btn.style.borderRight = "5px solid red";
        inp_so.style.border = "1.5px solid red";
        inp_so.style.borderRight = "5px solid red";
    } else {
